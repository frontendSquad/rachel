                        ...
                        <form action="">
                            ...
                            <div class="form-group py-2 position-relative">
                                ...
                                <div class="passwordWrapper position-relative">
                                    <input type="password" class="form-control border-0 shadow passInput" id="password" placeholder="Password">
                            ...
                            <div class="form-group">
                                <input type="submit" value="Sign In" class="form-control text-white bg-theme-primary">
                            </div>
                        </form>
                    </div>
                </div>

...
<div class="notification-section p-3">
    <div class="d-flex justify-content-between mt-4 mb-4">
        <div class="titleBox my-3">
            <h3 class="mb-0 achivpFont mb-0 font-weight-bold">Register Student</h3>
        </div>
    </div>
    <form action="">
        <div class="row my-3">
            ...
            <div class="col-md-12 mt-4 d-sm-flex d-block">
                <button class="btn bg-theme-primary text-white px-5 py-3" aria-label=".form-select-sm example" type="button" data-toggle="modal" data-target="#stuReg">Create Account</button>
            </div>
        </div>
    </form>

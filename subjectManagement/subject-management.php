...
<div class="notification-section p-3">
    <div class="titleBox my-3 d-sm-flex d-block justify-content-between align-items-center">
        <h3 class="mb-0 achivpFont  font-weight-bold">Subjects Management</h3>
        <div class="viewAllBtn">
            <p><a href="add-subject.php" class="btn bg-theme-primary text-white mt-sm-0 mt-3 px-4" role="button" data-toggle="button" aria-pressed="true">Create Subject</a></p>
        </div>
    </div>
...
<div class="notification-section shadow p-5 rounded-15 my-4">
    <div class="row justify-content-between">
        <div class="col-xl-4 col-md-6 mb-xl-0 mb-3 mt-sm-0 mt-3">
            <div class="selectBox">
                        ...
                        <td>
                            <div class="btn-group ml-1">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item mb-1" href="subject-management-details.php"><i class="bi bi-eye table-eye pr-2"></i>View</a>

...
<div class="notification-section p-3">
    <div class="titleBox my-3 d-flex justify-content-between align-items-center">
        <h3 class="mb-0 achivpFont mb-0 font-weight-bold">Subjects Management</h3>
        <div class="viewAllBtn">
            <p><a href="#" class="btn bg-theme-primary text-white px-4" role="button" data-toggle="button" aria-pressed="true">Create Subject</a></p>
        </div>
    </div>
    <div class="row shadow p-5 rounded-15">
        ...
        <div class="col-md-3 input-group w-auto">

...
<div class="notification-section p-3">
    <div class="titleBox my-3">
        <h3 class="mb-0 achivpFont mb-0 font-weight-bold">Teacher Management</h3>
    </div>
                        ...
                        <td>
                            <div class="btn-group ml-1">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item mb-1" href="./teacher-management-details.php"><i class="bi bi-eye table-eye pr-2"></i>View</a>
